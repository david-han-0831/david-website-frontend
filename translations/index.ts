    ...
    en: {
        reel: {
            ...
            patents: {
                ...
                ar: 'Get my card in AR',
                ar_title: 'Put my card on your desk.',
                ar_desc: 'Open this on a phone and tap the AR button. No app needed.',
                ar_scan: 'Scan to open on your phone',
                ar_view: 'View in your space',
                ar_close: 'Close',
            },
        },
        nav: {
    ...
    ko: {
        reel: {
            ...
            patents: {
                ...
                lecture: '강의·출강 문의',
                ar: 'AR로 명함 받기',
                ar_title: '제 명함을 책상 위에 올려보세요.',
                ar_desc: '휴대폰에서 열고 AR 버튼을 누르면 됩니다. 앱 설치는 필요 없습니다.',
                ar_scan: '휴대폰으로 스캔해서 열기',
                ar_view: '내 공간에서 보기',
                ar_close: '닫기',
            },
        },
    ...
    de: {
        reel: {
            ...
            patents: {
                ...
                ar: 'Visitenkarte in AR',
                ar_title: 'Stell meine Karte auf deinen Tisch.',
                ar_desc: 'Auf dem Handy öffnen und den AR-Button tippen. Keine App nötig.',
                ar_scan: 'Scannen und auf dem Handy öffnen',
                ar_view: 'In deinem Raum ansehen',
                ar_close: 'Schließen',
            },
        },
        nav: {
